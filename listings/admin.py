...
class DepositAdmin(admin.ModelAdmin):
    ...
    # Search targets, including relational lookups and both Stripe identifier tokens
    search_fields = ('user__username', 'property__title', 'stripe_payment_id', 'stripe_checkout_session_id')